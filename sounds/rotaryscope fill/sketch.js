function preload(){
  sound = loadSound('Come Together.mp3');
}
...
function draw(){
  ...
  //col_test = round(spectralCentroid*(255/10000));
  
  var rval = fft.getEnergy('bass');
  var bval = fft.getEnergy('mid');
  var gval = fft.getEnergy('treble');
